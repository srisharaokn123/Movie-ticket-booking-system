		...
		<header id="myCarousel" class="carousel slide">
			...
			<div class="carousel-inner">
				<div class="item active">
					<div class="fill" style="background-image:url('img/ws-te.jpg');"></div>
				</div>
				<div class="item">
					<div class="fill" style="background-image:url('img/ws-h.jpg');"></div>
				</div>
				<div class="item">
					<div class="fill" style="background-image:url('img/ws-so.jpg');"></div>
				</div>
				<div class="item">
					<div class="fill" style="background-image:url('img/ws-sv.jpg');"></div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
						<a href="https://youtu.be/UgJvX9-MNGc"><img class="img-responsive img-portfolio img-hover" src="img/cs-te.jpg" alt=""></a>
				</div>
				<div class="col-md-3 col-sm-6">
						<a href="https://youtu.be/dyzraT_np8w"><img class="img-responsive img-portfolio img-hover" src="img/cs-so.jpg" alt="">
				</div>
				<div class="col-md-3 col-sm-6">
						<a href="https://youtu.be/RxAtuMu_ph4"><img class="img-responsive img-portfolio img-hover" src="img/cs-dw.jpg" alt=""></a>
				</div>
				<div class="col-md-3 col-sm-6">
						<a href="https://youtu.be/u5r77-OQwa8"><img class="img-responsive img-portfolio img-hover" src="img/cs-sv.jpg" alt="">
				</div>
			</div>
			<br><br><br>
		</div>
