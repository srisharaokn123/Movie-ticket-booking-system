      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-1">
          <ul class="nav navbar-nav" id="left-nav">
			...
			<li>
              <a href="mov-tamil.php">TAMIL</a>
            </li>
			<li>
              <a href="mov-telugu.php">TELUGU</a>
            </li>
          </ul>
          <ul class="nav navbar-nav navbar-right">
            <li>
              <a href="faq.php"><span class="fa fa-question-circle" aria-hidden="true"></span>&nbsp;&nbsp;FAQs</a>
            </li>
            <li>
        ...
        echo '
          <li id="visible" class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="mybookings.php"><span class="fa fa-ticket" aria-hidden="true"></span>&nbsp;&nbsp;My Bookings</a></li>
