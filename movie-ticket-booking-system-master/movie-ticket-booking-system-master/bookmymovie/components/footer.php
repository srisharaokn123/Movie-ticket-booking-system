        ...
        <div class="row">
          <div class="col-sm-4 col-xs-6">
            ...
            <ul class="list-unstyled">
			  ...
			  <li><a href="mov-tamil.php">Tamil</a></li>
			  <li><a href="mov-telugu.php">Telugu</a></li>
            </ul>
          </div>
          ...
          <div class="col-xs-12 col-sm-4">
            <div class="nav navbar-nav" style="padding: 40px 10px;">
              ...
              <a class="btn btn-social-icon" href="#"><i class="fa fa-envelope-o fa-2x"></i></a>
            </div>
          </div>
          <div class="col-xs-12">
            <p style="padding:20px;"></p>
            <p align=center>Copyright © 2020 BookMyMovie</p>
          </div>
        </div>
      </div>
    </footer>
